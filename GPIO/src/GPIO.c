...
void set_speed_mode (t_GPIO_Bank *GPIOs)
{
	...
	GPIOs->GPIOB.OSPEEDR |= E_VERY_HIGH_SPEED << D_OFFSET_MODE_SPEED_PUPD11;
	GPIOs->GPIOB.OSPEEDR |= E_VERY_HIGH_SPEED << D_OFFSET_MODE_SPEED_PUPD12;
	GPIOs->GPIOB.OSPEEDR |= E_VERY_HIGH_SPEED << D_OFFSET_MODE_SPEED_PUPD13;
