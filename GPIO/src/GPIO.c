...
{
	GPIOs->GPIOA.OSPEEDR |= E_HIGH_SPEED << D_OFFSET_MODE_SPEED_PUPD1;
	GPIOs->GPIOA.OSPEEDR |= E_HIGH_SPEED << D_OFFSET_MODE_SPEED_PUPD2;
	GPIOs->GPIOA.OSPEEDR |= E_HIGH_SPEED << D_OFFSET_MODE_SPEED_PUPD7;
	GPIOs->GPIOB.OSPEEDR |= E_HIGH_SPEED << D_OFFSET_MODE_SPEED_PUPD11;
	GPIOs->GPIOB.OSPEEDR |= E_HIGH_SPEED << D_OFFSET_MODE_SPEED_PUPD12;
	GPIOs->GPIOB.OSPEEDR |= E_HIGH_SPEED << D_OFFSET_MODE_SPEED_PUPD13;
	GPIOs->GPIOC.OSPEEDR |= E_HIGH_SPEED << D_OFFSET_MODE_SPEED_PUPD1;
	GPIOs->GPIOC.OSPEEDR |= E_HIGH_SPEED << D_OFFSET_MODE_SPEED_PUPD4;
	GPIOs->GPIOC.OSPEEDR |= E_HIGH_SPEED << D_OFFSET_MODE_SPEED_PUPD5;
}
...
void set_num_alt_function(t_GPIO_Bank *GPIOs)
{
	...
	GPIOs->GPIOB.AFHR |= E_AF11 << D_OFFSET_ALTERNATE_FUNCTION3_11;
	GPIOs->GPIOB.AFHR |= E_AF11 << D_OFFSET_ALTERNATE_FUNCTION4_12;
	GPIOs->GPIOB.AFHR |= E_AF11 << D_OFFSET_ALTERNATE_FUNCTION5_13;
